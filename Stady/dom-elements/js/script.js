...
console.log(x);
//ДОМАШКА
/* indexx.html, к которому подключен этот файл, страшно его невзлюбил
// и не отображает изменения в нем (использован OpenServer).
// На замену создан другой файл another.js с тем же содержимым,
// который на удивление работает нормально. Глюк ((
1. Изучить теорию
2. Решить задачи:
*/
/*
